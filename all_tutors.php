              ...
              <td><?php echo $date; ?></td>
             	<td>
             	    <a class="btn btn-xs btn-primary" href="edit_ttr_data.php?id=<?php echo $row->id; ?>"><i class="fa fa-edit"></i></a>
             		  <a class="btn btn-xs btn-danger" onclick="return confirm('Are you sure you want to remove tutor(s)? ')" href="delete_ttr_data.php?id=<?php echo $row->id; ?>"><i class="fa fa-trash"></i></a>
             	</td>
             </tr>
        <?php
           }
